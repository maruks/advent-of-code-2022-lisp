...
(defsuite :day-9 ()
  ...
  (deftest "count-visited-2" ()
    (eql-p (day-9::count-visited-2 #Z((:R . 4) (:U . 4) (:L . 3) (:D . 1) (:R . 4) (:D . 1) (:L . 5) (:R . 2))) 1)
    (eql-p (day-9::count-visited-2 #Z((:R . 5) (:U . 8) (:L . 8) (:D . 3) (:R . 17) (:D . 10) (:L . 25) (:U . 20))) 36))
  (deftest "solution-2" ()
